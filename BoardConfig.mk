...
# Target Properties
TARGET_BOOTLOADER_BOARD_NAME := um840
TARGET_OTA_ASSERT_DEVICE := um840,Um840,UM840,ideos

# GPS
BOARD_VENDOR_QCOM_GPS_LOC_API_HARDWARE := um840
...
TARGET_KERNEL_CONFIG := cyanogen_um840_defconfig
BOARD_KERNEL_CMDLINE := mem=211M console=ttyMSM2,115200n8 androidboot.hardware=um840 mtdparts=msm_nand:5120k@51200k(boot),5120k@57088k(recovery),1280k@62208k(misc),384k@63488k(splash),235520k@63872k(system),25600k@299392k(cache),199296k@324992k(userdata)
